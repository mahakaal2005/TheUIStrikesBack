      ...
      {suggestions.length > 0
        ? suggestions.map((suggestion, index) => (
          ...
          >
            <button
              className={cn(
                "py-2 px-2.5 rounded-2xl text-sm transition-colors",
                "border border-flat",
        ...
        placeholders.map((_, index) => (
          <div
            ...
            className="py-2 px-2.5 rounded-2xl text-sm border border-flat bg-muted/20 text-transparent animate-pulse"
